...
module.exports.updateEmpresa = async function (empresa) {
	try {
		...
		queryData = ['empresas', 'nombre', empresa.nombre, 'NIT', empresa.NITNew, 'dueño', empresa.dueño, 'horarios', empresa.horarios, 'telefono', empresa.telefono, 'NIT', empresa.NITNEW];
